...
MP3DecInfo *AllocateBuffers(void)
{
   ...
   // return mp3DecInfo_pointer;
	...
	if (!fh || !si || !sfi || !hi || !di || !mi || !sbi) {
        //PRINTF("Can not Malloc enough buffer\r\n");
...
void FreeBuffers(MP3DecInfo *mp3DecInfo)
{
    ...
    if (!mp3DecInfo)
		return;
    memset((void*)&fh, 0x00, sizeof(FrameHeader));
    memset((void*)&si, 0x00, sizeof(SideInfo));
    memset((void*)&sfi,0x00, sizeof(ScaleFactorInfo));
    memset((void*)&hi, 0x00, sizeof(HuffmanInfo));
    memset((void*)&di, 0x00, sizeof(DequantInfo));
    memset((void*)&mi, 0x00, sizeof(IMDCTInfo));
    memset((void*)&sbi,0x00, sizeof(SubbandInfo));   
