...
static int Oasis_Init(int appType)
{
    ...
    OASISLTModelClass_t oasis_model_class_mode = OASISLT_MODEL_CLASS_NUM;

    memset(&gOasisLite, 0, sizeof(gOasisLite));

    if (appType == OASISLT_MODEL_CLASS_LIGHT)
    {
        oasis_model_class_mode = OASISLT_MODEL_CLASS_LIGHT;
    }
    else if(appType == OASISLT_MODEL_CLASS_HEAVY)
    {
        oasis_model_class_mode = OASISLT_MODEL_CLASS_HEAVY;
    }
    else
    {
        oasis_model_class_mode = OASISLT_MODEL_CLASS_LIGHT;
    ...
    gOasisLite.config.modClass             = oasis_model_class_mode;
...
extern "C" JNIEXPORT jint JNICALL Java_com_smartaccessmanager_utility_Algorithm_Init(JNIEnv *env, jobject obj, jint appType)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_smartaccessmanager_utility_Algorithm_Exit(JNIEnv *env, jobject obj)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_smartaccessmanager_utility_Algorithm_GetFaceSize(JNIEnv *env, jobject instance)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_smartaccessmanager_utility_Algorithm_GetVersion(JNIEnv *env, jobject instance)
{
    return  VERSION_MAJOR << 16 | VERSION_MINOR << 8 | VERSION_HOTFIX;
}

extern "C" JNIEXPORT jint JNICALL Java_com_smartaccessmanager_utility_Algorithm_Registration(JNIEnv *env, jobject obj,
