...
//        builder.setCancelable(false);
    ...
    private void pressFABCardButton(View v) {
        ...
        if(selectedMethods.contains(FACE)) {
    ...
    private final View.OnClickListener mAppClickHandler = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(itemPosition > 0) {
                unlockTypeList.get(itemPosition).checked = !unlockTypeList.get(itemPosition).checked;
    ...
    public class UnlockAdapter extends RecyclerView.Adapter<UnlockAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(@NonNull View itemView) {
                ...
                checkBox = itemView.findViewById((R.id.unlock_checkbox));
            }
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            MaterialCheckBox checkBoxView = unlockOptionView.findViewById(R.id.unlock_checkbox);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.checkBox.setChecked(unlockTypeList.get(position).checked);
            if(position == 4){
