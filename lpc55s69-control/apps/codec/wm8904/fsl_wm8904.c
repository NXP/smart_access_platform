...
status_t WM8904_Init(wm8904_handle_t *handle, wm8904_config_t *wm8904Config)
{
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_WRT_SEQUENCER_0 %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_WRT_SEQUENCER_3 %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_WaitOnWriteSequencer %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_ANALOG_LEFT_IN_0 %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_ANALOG_RIGHT_IN_0 %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_ANALOG_OUT1_LEFT %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_ANALOG_OUT1_RIGHT %d\r\n", result);
        return result;
    }
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_ANALOG_HP_0 %d\r\n", result);
        return result;
    }
#if 1
    result = WM8904_WriteRegister(handle, 0x5E, 0x00FF);
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_ANALOG_HP_0 %d\r\n", result);
        return result;
    ...
    if (result != kStatus_WM8904_Success)
    {
    	PRINTF("WM8904_CheckAudioFormat %d\r\n", result);
        return result;
    }
